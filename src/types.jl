...
Base.@kwdef mutable struct HistoryEntry
    historyIndex::Int
    code::String
end
StructTypes.StructType(::Type{HistoryEntry}) = StructTypes.Mutable()

Base.@kwdef mutable struct HistoryResult
    entries::Vector{HistoryEntry} = HistoryEntry[]
    hasMore::Bool = false
end
StructTypes.StructType(::Type{HistoryResult}) = StructTypes.Mutable()
